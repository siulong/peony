...
若删除的文件为可移动设备上，或者一些远程目录和特殊目录，删除选项是永久删除，本地文件删除选项是删除到回收站，在回收站可以看到删除的文件。
...
* 重命名：支持对移动设备（例如：U盘、移动硬盘等设备）进行重命名，也支持分区的重命名，有一些分区暂时不支持重命名（例如：文件系统分区、数据盘等）。
...
（2）设置：置顶窗口、显示隐藏文件、显示文件扩展名、禁用缩略图、常驻后台、允许并行操作、设置samba密码、在新窗口打开文件夹
...
|设置samba密码  |可以设置当前用户的samba密码
|在新窗口打开文件夹  |打开文件夹时是否是新窗口打开
|帮助	      |跳转到用户手册
|关于	      |显示文件浏览器的详细信息
...
## 文件保护箱
侧边栏显示的"保护箱", 是文件保护箱应用的插件，融入到文件管理器中，在侧边栏提供了文件保护箱操作的入口，具体功能以及操作，请参考文件保护箱手册。

![图 22 文件保护箱-big](image/22.png)
