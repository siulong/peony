...
（2）设置：置顶窗口、显示隐藏文件、显示文件扩展名、禁用缩略图、常驻后台、允许并行操作、设置samba共享密码
...
| F2  | 重命名  |
| Alt+D  | 激活地址栏 |
| Ctrl+E 或者 Ctrl+F 或者 F3 | 激活文件管理器窗口搜索框 |
| Ctrl+P | 显示/隐藏文件预览窗口 |
| Ctrl+Shift+N | 新建文件夹 |
| Home | 键盘焦点定焦内容区域首项 |
| End | 键盘焦点定焦内容区域末项 |
...
| Alt+ → | 按历史记录前进 |
| Ctrl+N | 新建文件管理器窗口 |
| Ctrl+W | 依次关闭桌面上的文件管理器窗口 |
| F11 | 最大化/还原，文件管理器窗口 |
| Ctrl+D 或者 Delete| 将选中项移到回收站 |
| Shift+F10 | 打开/关闭，选中项的右键菜单 |
| Shift+ ←  →  ↑ ↓ | 在窗口或桌面中连续选择多个项目 |
| Alt+Enter | 显示选中项的属性 |
