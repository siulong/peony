...
//    addSpacing(9 - 4);
    ...
    addWidget(goForward);
    connect(goForward, &QToolButton::clicked, m_window, [=]() {
    ...
    connect(goBack, &QToolButton::clicked, m_window, [=]() {
...
//    m_search_button = search;
    ...
    addWidget(search);
    connect(search, &QToolButton::clicked, this, &HeaderBar::searchButtonClicked);
